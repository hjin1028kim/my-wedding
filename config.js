...
const CONFIG = {
  ...
  greeting: {
    title: "소중한 분들을 초대합니다",
    content:
      "싱그러운 여름의 한가운데서\n저희 두 사람이 평생을 약속하게 되었습니다.\n\n무더위 속에서도 저희를 향해 발걸음 해주시는\n감사한 마음들을 모아,\n늘 시원한 바람 같은 부부가 되겠습니다.\n\n기쁜 날, 오셔서 축복해 주세요.",
  },
  ...
  story: {
    title: "우리의 이야기",
    content:
      "서로 다른 계절을 살아온 두 사람이 만나,\n가장 뜨거운 여름날 하나의 길을 시작합니다.\n\n무더위를 뚫고 찾아와주실 여러분의 소중한 발걸음을 기억하며,\n언제나 서로의 든든한 편이 되어 행복하게 살겠습니다.\n\n소중한 자리에 여러분을 초대합니다."
  },
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "원범희", bank: "신한은행", number: "110-123-456789" },
      { role: "아버지", name: "원용학", bank: "국민은행", number: "123-45-6789012" },
      { role: "어머니", name: "박순덕", bank: "우리은행", number: "1002-345-678901" },
    ],
    bride: [
      { role: "신부", name: "김현진", bank: "하나은행", number: "234-56-7890123" },
      { role: "아버지", name: "김세덕", bank: "농협", number: "301-0123-4567-01" },
      { role: "어머니", name: "이상우", bank: "기업은행", number: "012-345678-01-012" },
    ],
  },
